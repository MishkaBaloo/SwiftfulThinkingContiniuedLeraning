...
//
//  Created by Michael on 15.05.2024.
//
...
class CoreDataRelationshipViewModel: ObservableObject {
    ...
    func getBusinesses() {
        ...
        do {
           businesses = try manager.context.fetch(request)
            ...
            print("Error fetchong. \(error.localizedDescription)")
        }
    }
    ...
    func updateBusiness() {
        let existingBusinesss = businesses[2]
        existingBusinesss.addToDepartments(departments[1])
        save()
    }
    ...
    func addBusiness() {
        ...
        // add employee departments to the new business // we can add each other category to every Entity
